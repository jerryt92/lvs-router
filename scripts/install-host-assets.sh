...
install -m 0755 "$REPO_ROOT/scripts/start-ipvs-keepalived.sh" "$BIN_DIR/start-ipvs-keepalived.sh"
install -m 0755 "$REPO_ROOT/scripts/stop-ipvs-keepalived.sh" "$BIN_DIR/stop-ipvs-keepalived.sh"
